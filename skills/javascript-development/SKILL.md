...
description: This skill should be used when implementing or reviewing JavaScript or TypeScript logic, async control flow, browser or Node behavior, and modern language patterns.
compatibility: opencode
metadata:
  replaces-agent: javascript-pro
---
